...
function Main() {
    ...
    let [mintPrice, setMintPrice] = useState(BigNumber.from(0))
                            ...
                            <div className="w-full h-full row justify-between gap-4 pt-6">
                                ...
                                <div className="text-gray-400 w-1/2  norse md:p-4 flex flex-col gap-6 justify-between">
                                    ...
                                    <div className="px-3 flex flex-col md:flex-row between items-center gap-4">
                                        ...
                                        <div className="text-sm lg:text-xl w-full text-right flex flex-col lg:flex-row items-center justify-end">
                                            <div className="w-full row justify-end items-center">
                                            {
                                                <svg style={{opacity: updateFee?1:0}} aria-hidden="true" role="status" className="inline mr-3 w-4 h-4 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="row justify-end w-full">
                                                [
                                            {utils.formatEther(mintFee)}{isWhitelisted && !wlClaimed &&  <span className="text-green-500">(${utils.formatEther(mintPrice.mul(mintAmount))}-${utils.formatEther(mintPrice)})</span>}Ξ]
                                            </div>
                                        </div>
                                    </div>
