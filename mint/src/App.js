                            ...
                            <div className="w-full h-full row justify-between gap-4 pt-6">
                                ...
                                <div className="text-gray-400 w-1/2  norse md:p-4 flex flex-col gap-6 justify-between">
                                    ...
                                    <div className="px-3 flex flex-col md:flex-row between items-center gap-4">
                                        ...
                                        <div className="md:text-xl w-full text-right row items-center justify-end">
                                            {updateFee &&
                                            ...
                                            total: {utils.formatEther(mintFee)}{isWhitelisted && !wlClaimed &&  <span className="text-green-500">(${utils.formatEther(mintPrice.mul(mintAmount))}-${utils.formatEther(mintPrice)})</span>}Ξ
                                        </div>
                                    </div>
