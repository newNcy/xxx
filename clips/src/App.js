...
function Main() {
    ...
    return (
        <div className="App flex flex-col">
            <nav className="navbar w-full flex fixed top-0 left-0 px-8 py-4 justify-between items-center space-x-6"  style={{position: "sticky"}}>
                <ul className="items-center navbar-nav flex flex-row gap-5 text-xl text-bold ">
                    <div className="">
            ...
            <div style={{ overflow: 'auto'}}>
                <section>
                    <div className="flex h-full justify-center items-center pt-16 md:pt-0">
